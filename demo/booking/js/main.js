...
$(".btn-tim-ve").click(function (e) {
    ...
    if (flight_type == "roundway") {
        path += "&rt=" + dtpReturnDate;
    }

    location.href = "https://hoabinhairlines.vn/flight?" + path;
});
...
$(
    "#form_book_taxi, #form_book_road, #booktour, #form_book_agency, #book_rail_pass"
