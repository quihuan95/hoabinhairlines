                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="box-diem go-flight">
                                        ...
                                        <button class="btn btn-place bt-diem-di"><span class="txt-ellipse"
                                                data-code="HAN">Ha Noi (HAN) </span></button>

                                        <!-- Box Hidden -->
                                        <div class="box-select-option">
                                            <button class="btn btn-close close1">
                                                <i class="fa fa-times hidden-xs"></i>
                                                <b class="visible-xs"><i class="fa fa-window-close"
                                            ...
                                            <div class="div-in-search">
                                                ...
                                                <div class="div-input-search">
                                                    ...
                                                    <input type="text" placeholder="Nhập tên thành phố hoặc mã sân bay"
                                                        class="form-control typeahead input-flight" id="ddlReturnCity"
                                                        name="ddlReturnCity" value="">
                                                    <button
                                                        class="btn btn-orange-34 hidden-xs btn-choice-area">CHỌN</button>
                                                </div>
                                            ...
                                            <div class="row scroll-touch">
                                                <div class="kv-noi-dia row m0">
                                                    <div class="col-xs-12 col-sm-12 col-sm-4 p0">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li class="item-diem-di" data-code="SGN">TP. Hồ Chí Minh (SGN)
                                                            </li>
                                                ...
                                                <div class="kv-quoc-te row m0">
                                                    <div class="col-xs-12 col-sm-12 col-sm-4 p0">
                                                        <h3>Đông Dương</h3>
                                                        <ul>
                                                            <li class="item-diem-di" data-code="LPQ">Luang Prabang (LPQ)
                                                            </li>
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-sm-4 p0">
                                                        ...
                                                        <h3>Hoa Kỳ</h3>
                                                        <ul>
                                                            <li class="item-diem-di" data-code="ATL">Atlanta Hartsfield
                                                                (ATL)</li>
                                                            <li class="item-diem-di" data-code="AUS">Austin (AUS)</li>
                                                            <li class="item-diem-di" data-code="BOS">Boston, Logan (BOS)
                                                            </li>
                                                            <li class="item-diem-di" data-code="CHI">Chicago, IL (CHI)</li>
                                                            <li class="item-diem-di" data-code="DFW">Dallas/Fort Worth (DFW)
                                                            </li>
                                                            ...
                                                            <li class="item-diem-di" data-code="MSP">Minneapolis/St.Paul
                                                                (MSP)</li>
                                                            <li class="item-diem-di" data-code="PHL">Philadelphia (PHL)</li>
                                                            <li class="item-diem-di" data-code="PDX">Portland (PDX)</li>
                                                            <li class="item-diem-di" data-code="SFO">San Francisco (SFO)
                                                            </li>
                                                            <li class="item-diem-di" data-code="SEA">Seattle, Tacoma (SEA)
                                                            </li>
                                                            <li class="item-diem-di" data-code="STL">St Louis, Lambert (STL)
                                                            </li>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="box-diem back-flight">
                                        ...
                                        <button class="btn btn-place bt-diem-den"><span class="txt-ellipse"
                                                data-code="SGN">Hồ Chí Minh (SGN)</span></button>
                                        <div class="box-select-option">
                                            <button class="btn btn-close close1">
                                                <i class="fa fa-times hidden-xs"></i>
                                                <b class="visible-xs"><i class="fa fa-window-close"
                                                        aria-hidden="true"></i>Back</b>
                                            </button>
                                            <div class="title hidden-xs ">
                                                Lựa chọn thành phố hoặc sân bay xuất phát
                                            </div>
                                            <div class="div-in-search">
                                                ...
                                                <div class="div-input-search">
                                                    ...
                                                    <i class="fa fa-times"></i>
                                                    <input type="text" placeholder="Nhập tên thành phố hoặc mã sân bay"
                                                        class="form-control typeahead input-flight" id="city_name_back"
                                                        value="">
                                                    <button
                                                        class="btn btn-orange-34 hidden-xs btn-choice-area">CHỌN</button>
                                                </div>
                                            ...
                                            <div class="row scroll-touch">
                                                <div class="kv-noi-dia row m0">
                                                    <div class="col-xs-12 col-sm-12 col-sm-4 p0">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li class="item-diem-den" data-code="SGN">TP. Hồ Chí Minh (SGN)
                                                            </li>
                                                            ...
                                                            <li class="item-diem-den" data-code="BMV">Ban Mê Thuột (BMV)
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-sm-4 p0">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li class="item-diem-den" data-code="KUL">Kuala Lumpur (KUL)
                                                            </li>
                                                ...
                                                <div class="kv-quoc-te row m0">
                                                    <div class="col-xs-12 col-sm-12 col-sm-4 p0">
                                                        <h3>Đông Dương</h3>
                                                        <ul>
                                                            <li class="item-diem-den" data-code="LPQ">Luang Prabang (LPQ)
                                                            </li>
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-sm-4 p0">
                                                        ...
                                                        <h3>Hoa Kỳ</h3>
                                                        <ul>
                                                            <li class="item-diem-den" data-code="ATL">Atlanta Hartsfield
                                                                (ATL)</li>
                                                            <li class="item-diem-den" data-code="AUS">Austin (AUS)</li>
                                                            <li class="item-diem-den" data-code="BOS">Boston, Logan (BOS)
                                                            </li>
                                                            <li class="item-diem-den" data-code="CHI">Chicago, IL (CHI)</li>
                                                            <li class="item-diem-den" data-code="DFW">Dallas/Fort Worth
                                                                (DFW)</li>
                                                            ...
                                                            <li class="item-diem-den" data-code="MSP">Minneapolis/St.Paul
                                                                (MSP)</li>
                                                            <li class="item-diem-den" data-code="PHL">Philadelphia (PHL)
                                                            </li>
                                                            <li class="item-diem-den" data-code="PDX">Portland (PDX)</li>
                                                            <li class="item-diem-den" data-code="SFO">San Francisco (SFO)
                                                            </li>
                                                            <li class="item-diem-den" data-code="SEA">Seattle, Tacoma (SEA)
                                                            </li>
                                                            <li class="item-diem-den" data-code="STL">St Louis, Lambert
                                                                (STL)</li>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6 date-go">
                                    <div class="form-group form-date">
                                        ...
                                        <label class="control-label" for="date_di"><i class="fa fa-calendar"
                                                aria-hidden="true"></i></label>
                                        <input class="form-control" id="date_di" name="date_di" placeholder="DD/MM/YYYY"
                                            type="datetime" readonly="readonly" value="05/07/2022" />
                                    </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6 date-return">
                                    <div class="form-group form-date">
                                        ...
                                        <input class="form-control" id="date_ve" name="date_ve" placeholder="DD/MM/YYYY"
                                            type="datetime" readonly="readonly" value="08/07/2022" />
                                    ...
                                    <ul class="">
                                        <li class="">
                                            <div class="row m0">
                                                ...
                                                <div class="right">
                                                    <button class="btn btn-math" id="adults_minus"><i class="fa fa-minus"
                                                            aria-hidden="true"></i></button>
                                                    <span id="adults">1</span>
                                                    <button class="btn btn-math" id="adults_plus"><i class="fa fa-plus"
                                                            aria-hidden="true"></i></button>
                                                </div>
                                        ...
                                        <li class="">
                                            <div class="row m0">
                                                ...
                                                <div class="right">
                                                    <button class="btn btn-math" id="child_minus"><i class="fa fa-minus"
                                                            aria-hidden="true"></i></button>
                                                    <span id="child">0</span>
                                                    <button class="btn btn-math" id="child_plus"><i class="fa fa-plus"
                                                            aria-hidden="true"></i></button>
                                                </div>
                                        ...
                                        <li class="">
                                            <div class="row m0">
                                                ...
                                                <div class="right">
                                                    <button class="btn btn-math" id="baby_minus"><i class="fa fa-minus"
                                                            aria-hidden="true"></i></button>
                                                    <span id="baby">0</span>
                                                    <button class="btn btn-math" id="baby_plus"><i class="fa fa-plus"
                                                            aria-hidden="true"></i></button>
                                                </div>
                ...
                <div class="box-slider-lastest-news">
                    <div class="slider-lastest-news">
                        @foreach($news_banner as $kb => $vb)
                            <div>
                                <div class="item-ve">
                                    <a title="{!! $vb->title !!}" href="{{ URL::to($vb->slug) }}" rel="nofollow"
                                        target="_blank"><img src="{{ asset('public/uploads/news/' . $vb->picture) }}"
                                            style="width:100%;height:145px;"></a>
                                </div>
                            </div>
                        @endforeach
                    </div>
                    ...
                    <div class="booking-step" style="padding-left: 15px!important;">
                        <div class="row mt10">
                            <div class="col-xs-12 col-sm-12 col-md-12 p0 location-details">
                                <p>HoaBinh Airlines là thương hiệu chính thức của phòng vé công ty TNHH Thương mại và đầu tư
                                    du lịch quốc tế Hoà Bình – đại lý cấp I của các hãng hàng không Vietnam Airlines, Bamboo
                                    Airways, Vietjet Air và đối tác của nhiều hãng hàng không nổi tiếng thế giới.</p>
                                <p>Quý khách có thể đặt vé máy bay nhanh chóng, thuận tiện và tiết kiệm với chức năng đặt và
                                    thanh toán online.</p>
                                <div class="certificate-list mt15">
                                    <a class="certificate-item js-certificate-trigger" href="javascript:void(0);"
                                        ...
                                        data-title="Giấy phép Lữ hành Quốc tế">
                                    ...
                                    <a class="certificate-item js-certificate-trigger" href="javascript:void(0);"
                                        data-pdf-url="https://cdn.hoabinhevents.com/profiles/HBG_ChungnhanDailyVeMaybay.pdf"
                                        data-title="Chứng nhận đại lý">
                                        <span class="certificate-icon"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></span>
                                        <span class="certificate-content">
            ...
            <div class="row booking-type" id="cheap-flight">
                ...
                <div class="slider-ve-re">
                    ...
                    <div class="item-ve-cheap">
                        <img alt="Hà Nội - Phú Quốc"
                            src="https://hoabinhairlines.vn/public/frontend/css/images/ve1/ve-gia-re-di-PQC.png"
                            width="100%">
                    ...
                    <div class="item-ve-cheap">
                        <img alt="Đà Nẵng - Hồ Chí Minh"
                            src="https://hoabinhairlines.vn/public/frontend/css/images/ve1/ve-gia-re-di-SGN.png"
                            width="100%">
                        <div class="des-txt-cheap">
                            <div class="txt-top-cheap">
                    ...
                    <div class="item-ve-cheap">
                        <img alt="Đà Nẵng - Hà Nội"
                            src="https://hoabinhairlines.vn/public/frontend/css/images/ve1/ve-gia-re-di-HAN.png"
                            width="100%">
                        <div class="des-txt-cheap">
                            <div class="txt-top-cheap">
                    ...
                    <div class="item-ve-cheap">
                        <img alt="Hồ Chí Minh - Thanh Hóa"
                            src="https://hoabinhairlines.vn/public/frontend/css/images/ve1/ve-gia-re-di-THD.png"
                            width="100%">
                        <div class="des-txt-cheap">
                            <div class="txt-top-cheap">
                    ...
                    <div class="item-ve-cheap">
                        <img alt="Hà Nội - Đà Lạt"
                            src="https://hoabinhairlines.vn/public/frontend/css/images/ve1/ve-gia-re-di-DLI.png"
                            width="100%">
                        <div class="des-txt-cheap">
                            <div class="txt-top-cheap">
                                <h3>Hà Nội - Đà Lạt</h3>
                    ...
                    <div class="item-ve-cheap">
                        <img alt="Hồ Chí Minh - Vinh"
                            src="https://hoabinhairlines.vn/public/frontend/css/images/ve1/ve-gia-re-di-VII.png"
                            width="100%">
                        <div class="des-txt-cheap">
                            <div class="txt-top-cheap">
                    ...
                    <div class="item-ve-cheap">
                        <img alt="Hồ Chí Minh - Đà Nẵng"
                            src="https://hoabinhairlines.vn/public/frontend/css/images/ve1/ve-gia-re-di-DAD.png"
                            width="100%">
                        <div class="des-txt-cheap">
                            <div class="txt-top-cheap">
                    ...
                    <div class="item-ve-cheap">
                        <img alt="Hà Nội - Nha Trang"
                            src="https://hoabinhairlines.vn/public/frontend/css/images/ve1/ve-gia-re-di-CXR.png"
                            width="100%">
                        <div class="des-txt-cheap">
                            <div class="txt-top-cheap">
            ...
            <div class="col-xs-12 col-sm-12 col-sm-6 p0 pr15">
                ...
                <div class="booking-content p0">
                    <div class="booking-step">
                        <div class="num-st">1.</div>Trực tiếp trên website, nhanh nhất - tiện nhất
                    </div>
                    ...
                    <ul class="wPttt mt15">
                        <li class="row m0">
                            ...
                            <p> <b>THANH TOÁN BẰNG TIỀN MẶT TẠI VĂN PHÒNG HÒA BÌNH AIRLINES</b>
                                <br> <span class="">Sau khi đặt hàng thành công, Quý khách vui lòng qua văn phòng Hòa Bình
                                    Airlines để thanh toán và nhận vé.</span>
                            </p>
                            <div class="clr"></div>
                        </li>
                        <li class="row m0">
                            <div class="imgPttt">
                                <img class="thumb"
                                    src="https://hoabinhairlines.vn/public/frontend/css/images/HouseIcon.png">
                            </div>
                            <p> <b>THANH TOÁN TẠI NHÀ</b>
                                <br> <span>Nhân viên Hòa Bình Airlines sẽ giao vé & thu tiền tại nhà theo địa chỉ Quý khách
                                    cung cấp.</span>
                            </p>
                            <div class="clr"></div>
                        </li>
                        <li class="row m0" id="pament_paypal">
                            <div class="imgPttt">
                                <img class="thumb"
                                    src="https://hoabinhairlines.vn/public/frontend/css/images/nganluong.jpeg">
                            </div>
                        ...
                        <li class="row m0">
                            ...
                            <p> <b>THANH TOÁN QUA CHUYỂN KHOẢN</b>
                                <br> <span>Quý khách có thể thanh toán bằng cách chuyển khoản trực tiếp tại ngân hàng, qua
                                    thẻ ATM, hoặc qua Internet banking.</span>
                            </p>
                            <div class="clr"></div>
                        </li>
                    </ul>
    ...
    <div class="row m0 relative">
        ...
        <div class="box-email-km">
            <div class="box580 mt30">
                ...
                <div id="register-email-success" class="alert alert-success" style="display: none">Đăng ký nhận email khuyến
                    mãi thành công.</div>

                <div id="register-email-error" class="alert alert-danger" style="display: none">Đăng ký nhận email khuyến
                    mãi lỗi, vui lòng thử lại.</div>

                <div class="clearfix"></div>

                <div class="txt-89 fs20 txc">Đăng ký nhận tin khuyến mãi ngay để không bỏ lỡ các ưu đãi hấp dẫn mới nhất từ
                    <b>HoaBinh Airlines</b>!</div>

                <div class="form-email mt30 relative">
                    <form id="email_promotion111" role="form" action="{!! route('email.promotion') !!}" method="post">
                        {{ csrf_field() }}
                        <input type="email" class="form-control" placeholder="Nhập email của bạn tại đây" required
                            maxlength="255" name="email_promotion">
                        <i class="fa fa-envelope-o" aria-hidden="true"></i>
                        <button type="submit" class="btn btn-blue-40 font700"><i class="fa fa-paper-plane"
