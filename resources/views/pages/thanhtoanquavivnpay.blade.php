	...
	function fnFrmSubmit() {
		if(!fnValid()){
			...
			if(check_pay[0].checked===true){
				  document.getElementById("aspnetForm").action = "{!! route('payment.vnpay') !!}";
					...
					<div class="wapper_payment">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<form method="post" id="aspnetForm" name="aspnetForm" class=" " enctype="multipart/form-data">
								...
								<div class="form-group">
									<div class="col-md-3 col-sm-3 col-xs-12">
										<label for="txtDiachi" class="font_8">
											Địa chỉ :</label>
									</div>
									<div class="col-md-9 col-sm-9 col-xs-12">
										<input type="text" class="form-control" style="margin-bottom: 10px;" id="txtDiachi" name="txtDiachi" placeholder="">
									</div>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-md-9 col-sm-9 col-xs-12">
									<input type="text" class="form-control" style="margin-bottom: 10px;" id="txtSotien" name="txtSotien" placeholder="">
								</div>
							</div>
										...
										<div style="width:100%;height:auto;display:block;">
											<table style="float: left;">
												<tr>
													...
													<td class="tdtwo"><label for="momo"><img alt="Thanh Toán Bằng Ví MoMo" src="{{ asset('public/frontend/css/images/logo-primary.55e9c8c.svg') }}" style="height:25px;" /></label> </td>
													<td><label for="momo">Thanh Toán Bằng Ví VNPAY</label></td>
												</tr>
											</table>
										</div>
									</div>
