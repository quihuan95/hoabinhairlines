...
@section('content')
    {{ csrf_field() }}
    <!--<style type="text/css">
        #contenthomemain{ display: none; }
        .contentmainbody{ width: 100%;min-height: 500px;height: auto; }
    </style>
    <script type="text/javascript">
        $(window).scroll(function(){
            if ($(window).scrollTop() >= 79) {
                $('#contenthomemain').css({ 'display':'block' });
            }
        });
    </script>-->
   <div class="contentmainbody">
    ...
    <div id="ve_may_bay" class="tab-pane fade in active tab-pane1">
       <form method="post" action="https://hoabinhairlines.vn/demo/CheckFlight/checkbooking_new.php">
          <div class="row">
...
<div class="row booking-type" id="cheap-flight">
    ...
    <div class="row">
        <div class="col-md-12">
        <div class="overlay">
            <a class="overlay-ads" rel="nofollow" href="https://hoabinhairlines.vn/ve-may-bay-gia-re/ve-may-bay-gia-re-hoa-binh-airlines.html" target="_blank"><img class="img-responsive" style="height: 200px" src="https://hoabinhairlines.vn/public/userfiles/files/Ve%20may%20bay%20gia%20re%20la%20cum%20tu%20hot%20trong%20cong%20dong%20me%20xe%20dich%20HoaBinh%20Airline.jpg"></a><h3 style="width: fit-content"><a rel="nofollow" href="https://hoabinhairlines.vn/ve-may-bay-gia-re/ve-may-bay-gia-re-hoa-binh-airlines.html" target="_blank">Vé máy bay giá rẻ HoaBinh Airlines</a></h3></div></div>
     </div>
    ...
    <div class="col-xs-12 col-sm-12 col-sm-6 p0 pr15">
        ...
        <div class="booking-content p0">
            ...
            <div class="booking-step step-hotline">
                ...
                <div class="mt10"> <b><i class="fa fa-phone fs20" aria-hidden="true"></i> Tổng đài: <a href="tel:0913311911"><span class="txt-orange">0913 311 911 </span></a></b>
                </div>
            </div>
            <div class="booking-step">
