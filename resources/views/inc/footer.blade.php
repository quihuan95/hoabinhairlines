        ...
        <div class="">
            <div class="col-xs-12 col-sm-12 col-md-12 p0">
                <div class="row m0mb">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-5 pr0 pr15mb">
                        <iframe src="//www.facebook.com/plugins/likebox.php?href=https%3A%2F%2Fwww.facebook.com%2Fhoabinhairlines&amp;width=332&amp;height=546&amp;colorscheme=light&amp;show_faces=true&amp;header=true&amp;stream=false&amp;show_border=true&amp;appId=314391235375573" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100%; height:146px;" allowtransparency="true"></iframe>
                        <style type="text/css">
                          .duns_box{ margin: 20px 0; }
                          .duns_1{ float:left;position:relative;width: 100%; }
                          .duns_2{ position: absolute;top: -90px;right: -130px;text-align: right;z-index: 999999; }
                          @media only screen and (min-width: 320px) and (max-width: 736px)
                          {
                            .duns_2{ position: absolute;top: -90px;right: -162px;text-align: right; }
                          }
                      </style>
                        <div class="duns_box">
                            <a rel="nofollow" target="_blank" href='http://online.gov.vn/Home/WebDetails/93564'><img alt='Logo Bo Cong Thuong' title='' style="width:160px;height: 60px;max-width:100%;" src='https://hoabinhairlines.vn/public/userfiles/files/logoSaleNoti.webp'/></a>
            ...
            <!--<div class="clearfix"></div>
                <div class="widget__setting_support">
                    <a rel="nofollow" href="tel:0913311911" title="" class="btn-call">
                        <strong>0913 311 911</strong>
                        <span><i class="fa fa-phone"></i></span>
                    </a>
                    <div class="site-social">
                        <a rel="nofollow" href="https://www.messenger.com/t/hoabinhairlines" target="_blank" class="btn-social" title="Chat với chúng tôi qua facebook messenger">
                        ...
                        <div class="contact-footer">
                            <div class="list-contact-footer has-img-location">
                                <div>
                                    ...
                                    <p><i class="fa fa-phone mr5" aria-hidden="true"></i> +84.913.681.648</p>
