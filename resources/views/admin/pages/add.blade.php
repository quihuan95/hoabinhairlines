            ...
            <div class="col-xs-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form role="form" method="post" action="{!! route('admin.pages.create') !!}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                ...
                                <div id="all" class="tab-pane fade in active">
                                    <div class="contenttabs">
                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                            ...
                                            <div>
                                                <textarea class="form-control" placeholder="Mô tả" name="detailnews" id="ckeditor" rows="3"></textarea>
                                            </div>
