...
$config['licenseName'] = 'hoabinhairlines.vn';
$config['licenseKey']  = '*8?A-*1**-C**Y-*C**-*6**-7*F*-2**B';
...
$config['backends']['default'] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => 'https://hoabinhairlines.vn/public/userfiles/',//config('app.url').'/userfiles/',
